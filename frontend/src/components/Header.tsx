...
const Header: React.FC = () => {
    return (
        <header className="border-b" style={{ backgroundColor: '#1A1A1A', borderBottomColor: '#BE9E44' }}>
            <div className="max-w-full mx-auto px-4 sm:px-6">
                <div className="flex flex-col sm:flex-row items-center justify-between min-h-[5rem] sm:h-20 py-2 gap-4 sm:gap-0">
                    ...
                    <div className="text-center flex-1 sm:pr-6">
                        <h1 className="text-xl sm:text-2xl md:text-3xl tracking-widest uppercase" style={{ color: '#BE9E44', fontFamily: 'Cinzel, serif', fontWeight: 500, letterSpacing: '0.1em' }}>
